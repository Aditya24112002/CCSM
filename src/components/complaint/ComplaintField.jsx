...
function ComplaintField({ definition, value, onChange, isHighlighted }) {
  ...
  return (
    <label className={`field ${wide ? 'field-wide' : ''} ${isHighlighted ? 'field-ai-highlight' : ''} ${dateError ? 'field-error' : ''}`}>
      <span>{label}</span>
      <div className="field-control">
        {type === 'date' ? (
          <>
            <input type="text" inputMode="numeric" value={value} placeholder="DD/MM/YYYY" onChange={handleDateTextChange} onBlur={handleDateBlur} />
